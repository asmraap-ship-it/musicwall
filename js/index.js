...
async function bouwZoekKaartHtml(resultaat, idx) {
  ...
  return '<div class="card' + geselecteerdClass + '" onclick="toggleZoekSelectie(event, this,' + idx + ')">'
    ...
    + '<div class="card-meta">'
    + '<div class="card-artist">' + escapeHtml(resultaat.artiest || '') + '</div>'
    + '<div class="card-title">' + escapeHtml(resultaat.titel) + '</div>'
...
function bouwKaartHtml(video, wallId, idx, n) {
  ...
  return '<div class="card' + geselecteerdClass + '" id="c' + wallId + '-' + n + '" data-video-id="' + video.id + '" data-flip-id="video-' + video.id + '"'
    ...
    + '<div class="card-meta">'
    + '<div class="card-artist">' + escapeHtml(video.artiest || '') + '</div>'
    + '<div class="card-title">' + escapeHtml(video.titel) + '</div>'
    + '<div class="card-tag">\u25cf ' + escapeHtml(video.tag || '') + '</div>'
    + '</div>'
